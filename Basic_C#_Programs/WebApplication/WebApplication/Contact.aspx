...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <address>
        Hello! Type in a message to play with this label ( P.s it will chage this label to whatever you input ) </address>
    <address>
        <asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged" Width="161px"></asp:TextBox>
    </address>
    <address>

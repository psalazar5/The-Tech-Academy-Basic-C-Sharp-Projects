...
namespace ClassSubmissionVoidAssignment
{
    class Car
    {
        ...
        //and outputs the result of dividing the parameter by 2
        ...
        //created an overload version of myMethod that takes in an integer parameter and an output parameter that will be used to output the result 
